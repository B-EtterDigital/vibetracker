...
export function buildInstallRunway(): InstallRunway {
  const tracks: InstallRunwayTrack[] = [
    ...
    },
    {
      ...
      impact: "local",
      command: cliSequence(["detect", "providers --all"], " && "),
    ...
    },
    {
      ...
      impact: "usage",
      command: cliSequence(["sync --demo", "audit"]),
    ...
    },
    {
      ...
      impact: "creator",
      command: cliCommand("add elevenlabs --characters 12000 --category audio"),
    ...
    },
    {
      ...
      impact: "publish",
      command: cliSequence(["upload --dry-run", "upload --handle you"]),
