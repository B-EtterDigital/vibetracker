...
const decks: HomeControlTowerDeck[] = [
  ...
  },
  {
    ...
    label: "Motion lab",
    route: "/motion",
    command: "vibetracker motion --credits",
    rail: "credit",
    status: "OSS CREDIT",
  ...
  },
  {
    ...
    label: "Scan room",
    route: "/scan",
    command: "vibetracker scan --providers --dry-run",
    rail: "usage",
    status: "DRY RUN",
  ...
  },
  {
    ...
    label: "Source atlas",
    route: "/sources",
    command: "vibetracker sources --world",
    rail: "local_only",
    status: "LOCAL MAP",
  ...
  },
  {
    ...
    label: "Score mixer",
    route: "/score",
    command: "vibetracker score --explain",
    rail: "score",
    status: "+0 TRUST",
  ...
  },
  {
    ...
    label: "AI life",
    route: "/life",
    command: "vibetracker life --all-areas",
    rail: "local_only",
    status: "ALL VIBERS",
