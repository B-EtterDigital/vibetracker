...
const FORGE_META: Record<string, Omit<ContributorForgePacket, keyof ContributorBadgeInput | "rankImpact" | "usageImpact" | "terminal">> = {
  ...
  "fixture-steward": {
    ...
    command: "vibetracker fixture redact raw.json --out usage.sample.json",
  ...
  "local-ai-mapper": {
    ...
    command: "vibetracker detect --target http://127.0.0.1:1234",
...
export function buildContributorLaunchpad(packets: ContributorForgePacket[]): ContributorLaunchpad {
  ...
  const lanes: ContributorLaunchpadLane[] = [
    ...
    },
    {
      id: "publish-credit",
      call: "UNITE",
      label: "Publish contributor credit",
      impact: "publish",
      command: "vibetracker contributors badge --publish",
      path: "contributors/badges.json",
      issue: "Give maintainers a reviewed public credit packet for adapters, fixtures, trust, local, or privacy work.",
      note: "This is where Vibers Unite becomes visible on c0vibe.app without touching usage totals.",
...
export function buildContributorQuestBoard(packets: ContributorForgePacket[]): ContributorQuestBoard {
  ...
  const quests: ContributorQuest[] = [
    ...
    },
    {
      ...
      impact: "regional",
      command: "vibetracker adapter scaffold qwen",
    ...
    },
    {
      id: "publish-badge",
      call: "06",
      label: "Publish public credit",
      impact: "publish",
      command: "vibetracker contributors badge --publish",
      issue: "Maintainer-reviewed public badge for adapter, fixture, trust, privacy, or local work",
      proof: "Merged contribution, reviewed badge metadata, and C0VIBE public credit copy.",
...
export function buildContributorAdapterFoundry(packets: ContributorForgePacket[]): ContributorAdapterFoundry {
  ...
  const lanes: ContributorAdapterFoundryLane[] = [
    ...
    },
    {
      ...
      impact: "publish",
      command: "vibetracker contributors badge --publish",
      value: "C0VIBE public credit",
      issue: "Maintainer-reviewed badge publication for useful adapter work",
      note: "Gives contributors visible credit on C0VIBE without turning badges into usage.",
