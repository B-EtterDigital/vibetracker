...
export function buildWizardFlightRecorder(): WizardFlightRecorder {
  ...
  const events: WizardFlightRecorderEvent[] = [
    ...
    event({
      ...
      second: "28s",
      label: "Scan preview",
      command: "vibetracker scan --providers",
      value: "surprise reel",
    ...
    event({
      ...
      second: "60s",
      label: "Public relay",
      command: "vibetracker upload --profile",
      value: "Vibers Unite",
  ...
  const steps: ScanCommandRunwayStep[] = [
    {
      ...
      command: "vibetracker doctor --surprises",
    ...
    },
    {
      ...
      command: "vibetracker sync --providers creator",
