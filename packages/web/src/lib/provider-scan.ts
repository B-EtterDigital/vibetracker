...
const COLLECTION_SEQUENCE: ProviderCollectionStepDef[] = [
  ...
  },
  {
    ...
    badge: "trust signal",
    command: "vibetracker trust sync --source github,codex",
  ...
  },
  {
    ...
    command: "vibetracker sync --providers qwen,doubao,mistral",
  ...
  },
  {
    ...
    command: "vibetracker add midjourney --usd <amount>",
  ...
  },
  {
    ...
    label: "C0VIBE relay",
    badge: "publish rail",
    command: "vibetracker upload --dry-run && vibetracker upload",
...
const WORLD_ZONES: ProviderWorldZoneDef[] = [
  ...
  },
  {
    ...
    impact: "usage",
    command: "vibetracker sync --providers qwen,doubao,kimi",
  ...
  },
  {
    ...
    impact: "usage",
    command: "vibetracker sync --providers mistral,aleph-alpha,lighton",
  ...
  },
  {
    ...
    impact: "trust",
    command: "vibetracker trust sync --source codex,github",
...
const SIGNAL_MARQUEE_RAILS: ProviderSignalMarqueeRailDef[] = [
  ...
  },
  {
    ...
    call: "CN/EU",
    label: "Regional mesh",
    command: "vibetracker sync --providers qwen,doubao,kimi,mistral",
    impact: "usage",
  ...
  },
  {
    ...
    call: "CX/GH",
    label: "Builder proof",
    command: "vibetracker trust sync --source codex,github,antigravity",
    impact: "trust",
...
const COLLECTION_COMMAND_WALL_CHANNELS: ProviderCollectionCommandChannelDef[] = [
  {
    ...
    command: "vibetracker sync --providers higgsfield,replicate,falai,openai --dry-run",
    impact: "usage",
  ...
  },
  {
    ...
    command: "vibetracker detect --local --review",
    impact: "local_only",
  ...
  },
  {
    ...
    command: "vibetracker trust sync --source github,codex,claude,antigravity",
    impact: "trust",
  ...
  },
  {
    ...
    command: "vibetracker sync --providers qwen,doubao,kimi,mistral,aleph-alpha --dry-run",
    impact: "usage",
  ...
  },
  {
    ...
    command: "vibetracker add midjourney --usd <amount> --label manual",
    impact: "manual",
...
const FRESHNESS_RADAR_LANES: ProviderFreshnessLaneDef[] = [
  {
    ...
    command: "vibetracker sync --verified --dry-run",
    impact: "usage",
  ...
  },
  {
    ...
    command: "vibetracker capability check --built --no-provider-calls",
    impact: "usage",
  ...
  },
  {
    ...
    command: "vibetracker detect --local --no-upload",
    impact: "local_only",
  ...
  },
  {
    ...
    command: "vibetracker add <provider> --usd <amount> --label manual",
    impact: "manual",
  ...
  },
  {
    ...
    command: "vibetracker upload --dry-run --explain",
    impact: "publish",
...
function passportCommand(provider: ProviderDescriptor): string {
  if (provider.status === "built" || provider.verified) return `vibetracker sync --provider ${provider.id}`;
  if (provider.tier === "proxy") return `vibetracker proxy --provider ${provider.id}`;
  if (provider.tier === "manual" || provider.status === "manual-only") return `vibetracker add ${provider.id} --usd <amount>`;
  if (provider.auth === "localLogs") return `vibetracker detect --provider ${provider.id}`;
  return `vibetracker connect ${provider.id}`;
}
