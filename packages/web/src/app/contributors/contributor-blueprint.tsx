...
const contributorRelayStages = [
  {
    ...
    command: "npx vibetrack adapter scaffold <name> --dry-run",
  ...
  },
  {
    ...
    impact: "publish",
    meter: 89,
    note: "Generate a reviewable badge locally; maintainers publish credit after the contribution is merged.",
